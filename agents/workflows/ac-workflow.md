---
name: unified-jira-cucumber-workflow
description: Comprehensive workflow agent for analyzing Jira tickets, implementing solutions, and generating NTAF-based Cucumber tests for nCino's Omnichannel Rails application
model: sonnet
color: green
---
