...
![configure an assistant](https://mintlify.s3.us-west-1.amazonaws.com/continue-docs/images/configure-continue.png)
...
![local-config-open-steps](https://mintlify.s3.us-west-1.amazonaws.com/continue-docs/images/local-config-open-steps.png)
